...
// Note: TestTryResolveBuiltinResource was removed because we no longer use
// a static fast-path for scope resolution. All resource scope is now determined
// via Kubernetes API discovery for correctness with CRDs and evolving K8s APIs.
